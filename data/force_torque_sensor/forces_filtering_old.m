function [F_r, T_r, ft_bias] = forces_filtering(F_s, T_s, thetas, t, counter, m, l, varargin)
...
% filtering of the data at 30Hz (TODO, make this an argument...)
% /!\ the torque gravity compensation is not yet implemented !!
%
%DESCRIPTION:
%
...
%  m: estimated mass of the sensor
%  l: estimated arm lever of the sensor
%
%The basic syntax
%
%     []=forces_filtering(F_s, T_s, thetas, t, counter, m, l) 
%
...
if (filtering == 'TRUE') | (filtering == 1)
    ...
    freq = length(t)/t(end);
    filter_order = 100;
    fir_filter = fir1(filter_order, (20/(freq/2)), 'low');
