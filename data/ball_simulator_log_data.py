...
plt.plot(stamp, ball_height, 'ro', markersize=1.5, label='ball')
plt.legend(loc='best')
...
plt.plot(stamp, arm_height, 'b', markersize=1.0, linewidth=0.75, label='height')
plt.plot(stamp, virtual_paddle_height, 'g+', markersize=6.0, label='virtual')
