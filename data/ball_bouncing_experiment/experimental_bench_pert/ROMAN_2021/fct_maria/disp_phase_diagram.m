...
for i = 1:length(traject)
    idx_pert1 = vertcat(cycles{i}([cycles{i}.type_dist] == 1).glob_ind);
    idx_pert2 = vertcat(cycles{i}([cycles{i}.type_dist] == 2).glob_ind);
    idx_pert3 = vertcat(cycles{i}([cycles{i}.type_dist] == 3).glob_ind);
