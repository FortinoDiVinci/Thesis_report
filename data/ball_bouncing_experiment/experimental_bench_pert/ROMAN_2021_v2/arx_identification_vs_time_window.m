...
plot((50:1:200), r2_adj_mean2, '--', 'Linewidth', line_width, 'Color', [0, 0.4470, 0.7410])
...
hold on
%errorbar((50:1:200), K_mean4, K_std4)
plotStdSurface(K_mean5', K_std5', (50:1:200), [0, 0.4470, 0.7410], 1)
plot((50:1:200), K_mean5, '--', 'Linewidth', line_width, 'Color', [0, 0.4470, 0.7410])
plot([50, 200], K_mean5(end)/100*105+[0,0], '--', 'Color', [0.8500, 0.3250, 0.0980])
plot([50, 200], K_mean5(end)/100*95+[0,0], '--', 'Color', [0.8500, 0.3250, 0.0980])
xlabel('Nb samples')
ylabel('Stiffness (Nm^{-1})')
ax = gca;
ax.YAxis.Exponent = 3;
...
hold on
%errorbar((50:1:200), B_mean4, B_std4)
plotStdSurface(B_mean5', B_std5', (50:1:200), [0, 0.4470, 0.7410], 1)
plot((50:1:200), B_mean5, '--', 'Linewidth', line_width, 'Color', [0, 0.4470, 0.7410])
plot([50, 200], B_mean5(end)/100*105+[0,0], '--', 'Color', [0.8500, 0.3250, 0.0980])
plot([50, 200], B_mean5(end)/100*95+[0,0], '--', 'Color', [0.8500, 0.3250, 0.0980])
xlabel('Nb samples')
ylabel('Damping (Nsm^{-1})')
%subplot(2,2,4)
nexttile
hold on
%errorbar((50:1:200), M_mean4, M_std4)
plotStdSurface(M_mean5', M_std5', (50:1:200), [0, 0.4470, 0.7410], 1)
plot((50:1:200), M_mean5, '--', 'Linewidth', line_width, 'Color', [0, 0.4470, 0.7410])
plot([50, 200], M_mean5(end)/100*105+[0,0], '--', 'Color', [0.8500, 0.3250, 0.0980])
plot([50, 200], M_mean5(end)/100*95+[0,0], '--', 'Color', [0.8500, 0.3250, 0.0980])
xlabel('Nb samples')
ylabel('Mass (kg)')
