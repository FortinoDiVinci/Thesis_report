\begin{figure} %[thpb]
	...
	\shorthandon{;} 
	\caption{Variations des termes matriciels de \cref{eq_coupling_effect_jacobian}, pour $ q_3 = 1.5 $. La position articulaire $ q_1 = 1.68 $ est signalée par des marqueurs circulaires. (a) Termes de la diagonale influençant la position en $ x $, (a) termes de couplages en $ x $ qui sont multipliés par  $ f_z $. Les positions articulaires sont données en radians.}
