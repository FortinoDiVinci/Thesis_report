\begin{figure} %[thpb]
	...
	\shorthandon{;} 
	\caption{Variation of terms from matrix \cref{eq_coupling_effect_jacobian}, for $ q_3 = 1.5 $ (a) Diagonal term on $ x $, (b) Coupling term on $ x $ multiplied by $ f_z $. Joint values are provided in radians.}
