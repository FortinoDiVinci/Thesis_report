...
\begin{appendices}
	...
	La raideur cartésienne $ \matr{K} $ se définit respectivement aux coordonnées d'un repère défini par les vecteurs $\vect{x}$, qui peuvent former un plan, ou un espace de pluri-dimensionel.
