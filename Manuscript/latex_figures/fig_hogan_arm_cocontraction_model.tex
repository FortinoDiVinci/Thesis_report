\begin{figure} [h]
	...
	\caption{Modélisation simpliste de l'articulation du coude, avec l'action agoniste du biceps $b$ et antagoniste du triceps $t$. Les muscles sont considérés comme de simples raideurs variables, l'inertie du bras, la viscosité des muscles ainsi que le couple gravitationnel sont pris en compte lors des calculs présentés par \cite{hogan_adaptive_1984}. Ce modèle est valide pour de faibles vitesses (linéarisation de la viscosité), et de petites variations de posture (la dépendance articulaire \cite{rack_effects_1969, vredenbregt_surface_1973} étant négligée).}
