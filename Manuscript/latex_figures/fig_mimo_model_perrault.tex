\begin{figure} [h]
	...
	\end{tikzpicture}
	\caption[Modélisation en impédance d'un système MIMO \parencite{perreault_multiple-input_1999}]{Modèle à plusieurs entrées et sorties proposé par \textcite{perreault_multiple-input_1999}, avec $h_{ij}$ la fonction de transfert liant l'entrée $e_i$ à la sortie $y_j$.}
