\begin{figure} [h]
	...
	\caption{Simulation pour l'identification des paramètres en impédance avec des signaux en force issus d'expérimentation sans perturbations. Les signaux expérimentaux sont échantillonnés à \SI{1}{\kilo\hertz}.}
