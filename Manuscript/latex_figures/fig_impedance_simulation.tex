\begin{figure} [h]
	...
	\subcaptionbox{Perturbation simulée en force $\vect{f}_p$\label{subfig_impedance_simulation_b}}
	{
	...
	\caption[Schéma bloc de la simulation conçue pour tester la méthode d'identification]{Simulation pour l'identification des paramètres en impédance avec des signaux en force issus d'expérimentation sans perturbations. Les signaux expérimentaux sont échantillonnés à \SI{1}{\kilo\hertz}.}
