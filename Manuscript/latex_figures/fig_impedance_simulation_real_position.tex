\begin{figure} [h]
	...
	\end{tikzpicture}
	\caption[Schéma bloc de la simulation conçue pour tester la méthode d'identification, avec des trajectoires en position expérimentale]{Simulation pour l'identification des paramètres en impédance avec des signaux en force issus d'expérimentations sans perturbations.}
