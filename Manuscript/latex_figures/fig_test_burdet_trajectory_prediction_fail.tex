...
%				\coordinate (c2) at (axis cs:580, \pgfkeysvalueof{/pgfplots/ymax});				
	...
	\caption{Exemple d'application de la méthodologie de \textcite{burdet_method_2000} pour une estimation de trajectoire en position sur \SI{200}{\milli\second} peu satisfaisante. A la fin de cette fenêtre temporelle, l'erreur est de \SI{5.9}{\milli\meter} pour une amplitude de mouvement supérieure à \SI{8}{\centi\meter}, ce qui correspond à une erreur relative d'environ \SI{7}{\percent}.}
