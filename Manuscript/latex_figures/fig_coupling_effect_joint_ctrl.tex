\begin{figure} %[thpb]
	...
	\resizebox{\textwidth}{!}{%
		\begin{minipage}[b]{.5\linewidth}
			...
			{
				\tikzsetnextfilename{fig_coupling_effect_joint_ctrl_a}
				\begin{tikzpicture} [%
					declare function = {%
		...
		\begin{minipage}[b]{.5\linewidth}
			...
			{
				\tikzsetnextfilename{fig_coupling_effect_joint_ctrl_b}
				\begin{tikzpicture}  [%
				declare function = {%
	...
	%\shorthandon{;} 
	\caption[Variations des termes matriciels des effets de couplage]{Variations des termes matriciels de \cref{eq_coupling_effect_jacobian}, pour $ q_3 = 1.5 $. La position articulaire $ q_1 = 1.68 $ est signalée par des marqueurs circulaires. (\subref{subfig_coupling_effect_a}) Termes de la diagonale influençant la position en $ x $, (\subref{subfig_coupling_effect_b}) termes de couplages en $ x $ qui sont multipliés par  $ f_z $. Les positions articulaires sont données en radians.}
