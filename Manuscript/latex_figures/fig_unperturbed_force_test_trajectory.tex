\begin{figure}[!htb] 
	\centering
		\resizebox{\textwidth}{!}{
			\subcaptionbox{Morceau de \SI{30}{\second} de la trajectoire en force (affichage sous-échantillonné à \SI{100}{\hertz})\label{subfig_unp_force_test_trajectory_a}}
			{
		...
		\resizebox{\textwidth}{!}{
			\subcaptionbox{Caractéristiques fréquentielle et d'amplitude des cycles\label{subfig_unp_force_test_trajectory_b}}
			{
	...
	\caption{Exemple d'une trajectoire en force de \SI{4.5}{\minute}, en l'absence de perturbations et de retours haptiques, pour un total de plus de 220 cycles. Lors de l'interaction avec le robot, le bras de l'utilisateur est soumis à son propre poids ainsi qu'à la masse inertielle du robot.}
