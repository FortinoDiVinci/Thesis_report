\begin{figure}[!htb] 
	\centering
		\resizebox{\textwidth}{!}{
			\subcaptionbox{Morceau de \SI{30}{\second} de la trajectoire en force (affichage sous-échantillonné à \SI{100}{\hertz}, pour la première session)\label{subfig_unp_force_test_trajectory_a}}
			{
