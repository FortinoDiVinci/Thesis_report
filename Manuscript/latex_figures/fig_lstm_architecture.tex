...
\end{tikzpicture}
\vspace{1mm}
\captionof{figure}{Architecture LSTM classique, les couches neuronales sont représentées par les rectangles violets, et les opérateurs élémentaires (opération élément par élément, par exemple produit de Hadamard pour les multiplications) sont représentés par des ellipses ou cercles gris. Le point noir indique la concaténation des entrées et de l'état caché précédent.}
