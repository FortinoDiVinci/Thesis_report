\begin{figure}[h]
	...
	\begin{tikzpicture} [node distance = 2cm]
		...
		node[midway, above] {$\vect{v}$};
	\end{tikzpicture}
	\caption[Ports d'interaction entre un robot et son environnement]{Ports d'interaction entre un robot et son environnement dans deux configurations différentes.}
