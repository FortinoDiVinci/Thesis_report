\begin{figure}
	\resizebox{\textwidth}{!}{
		...
		\subcaptionbox{%Marges de phase pour une raideur nominale
			Raideur nominale ($K_n=196$)\label{subfig_theory_stability_map_nominal_stiffness}}
		{
		...
		\subcaptionbox{%Marges de phase pour une raideur multipliée par 3
			Raideur supposée en cocontraction ($K_r=3K_n=588$)\label{subfig_theory_stability_map_high_stiffness}}
		{
