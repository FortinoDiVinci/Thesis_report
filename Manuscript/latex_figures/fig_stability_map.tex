			...
			\subcaptionbox{\label{subfig_exp_stability_map_a}}
			{
				...
				\begin{tikzpicture}
					...
					\begin{axis}[
				        ...
				        \node[align=center] at (axis cs:.004,.23) (cond2) {zone stable\\2\textsuperscript{ème} condition};
				        \draw[-{Latex[length=2.5mm]}] (cond2.south) -- (axis cs:.005,.18);
