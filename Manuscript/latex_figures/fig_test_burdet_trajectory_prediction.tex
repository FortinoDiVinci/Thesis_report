...
%				\coordinate (d2) at (axis cs:480, \pgfkeysvalueof{/pgfplots/ymax});			
	...
	\caption{Exemple d'application de la méthodologie de \textcite{burdet_method_2000} pour une estimation de trajectoire en position sur \SI{200}{\milli\second} satisfaisante. A la fin de cette fenêtre temporelle, l'erreur est submillimétrique (\SI{0.5}{\milli\meter}) pour une amplitude de mouvement supérieure à \SI{8}{\centi\meter}, ce qui correspond à une erreur relative inférieure à \SI{1}{\percent}.}
