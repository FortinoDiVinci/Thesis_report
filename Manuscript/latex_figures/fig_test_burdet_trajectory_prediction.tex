...
\begin{figure}[!htb] 
	\centering
		\resizebox{\textwidth}{!}{
			...
			{
				\tikzsetnextfilename{fig_test_burdet_trajectory_pShiraziction_a}
				\begin{tikzpicture}
				\centering
				%
	...
	\\
		\resizebox{\textwidth}{!}{
			...
			{
				\tikzsetnextfilename{fig_test_burdet_trajectory_pShiraziction_b}
				\begin{tikzpicture}
				\centering
				%
	...
	\caption[Exemples d'application de la méthodologie décrite par \textcite{burdet_method_2000} pour la prédiction de trajectoires]{Exemples d'application de la méthodologie de \textcite{burdet_method_2000} pour deux estimations de trajectoire en position sur \SI{200}{\milli\second}. Sur l'ensemble des courbes candidates, seules 45 sont représentées.}
