\begin{figure}
		\tikzsetnextfilename{fig_endpoint_admittance_ctrl}
		...
		\only<8>{
			\node[block, left of = c1, node distance = 1.75cm, line width=1.4, pattern=north east lines, pattern color=Prune, opacity=0.35] {$\jacobianHat{q}{}{-1}$};
		}
